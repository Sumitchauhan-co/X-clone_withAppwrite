...
const Home = () => {
  const [WhatsHappeingClicked, setWhatsHappeingClicked] = useState(false);
  ...
  return (
    ...
    >
      ...
      <div>
        <div className="h-[fit] w-full sm:flex border-b border-(--border-color) hidden lg:p-0 p-[0_10px_0_10px] shrink-0">
          <div className="h-[10vh] w-[10%] flex items-center justify-center">
            <div className="h-7 w-7 lg:h-9 lg:w-9 border rounded-[50%] grid place-content-center lg:text-xl bg-[#84c346] text-white cursor-pointer">
              <span>S</span>
            </div>
          </div>
          <div className="h-full w-[90%] flex flex-col">
            <div
              onClick={() => setWhatsHappeingClicked(true)}
              className="h-[8vh] w-full text-neutral-500 flex items-center justify-start"
            >
              <input
                className="h-full w-full border-none outline-none text-[1.15rem]"
                type="text"
                placeholder="What's Happening?"
              />
            </div>
            {WhatsHappeingClicked && (
              <div className="h-[5vh] w-[90%] flex justify-start items-center border-b border-(--border-color)">
                <div className="h-fit w-fit p-1 flex justify-center items-center gap-2 fill-blue-400 rounded-2xl hover:bg-[#1d9aed10]">
                  ...
                  <div className="text-[0.8rem] text-blue-400 text-center">
            ...
            <div className="h-[7vh] w-full flex">
              <div className="h-full w-full flex items-center justify-start">
                <div className="h-7 w-7 p-1 fill-[#1d99ed] border rounded-[50%] hover:bg-[#1d9aed25] cursor-pointer">
              ...
              <div className="h-full w-[20%] flex justify-center items-center">
                <div className="h-9 w-16 bg-white hover:bg-neutral-200 border rounded-3xl text-black font-semibold grid place-content-center cursor-pointer">
                  <span>Post</span>
                </div>
              </div>
            </div>
