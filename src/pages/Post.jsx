          ...
          <div className="h-[7vh] w-full flex pt-5">
            <div className="h-full w-full flex items-center justify-start">
              <div
                ...
                className="h-7 w-7 p-1 fill-(--fill-blue-color) border-black rounded-[50%] hover:bg-[#1d9aed25] cursor-pointer"
              >
                <input
                  type="file"
                  ref={fileInputRef}
              ...
              <div className="h-7 w-7 p-1 fill-(--fill-blue-color) border-black rounded-[50%] hover:bg-(--bg-dark-blue-color) cursor-pointer">
                <svg viewBox="0 0 24 24" aria-hidden="true" class="">
                  <g>
