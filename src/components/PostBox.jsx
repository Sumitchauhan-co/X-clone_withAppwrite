    ...
    <>
        <div className="w-full sm:flex border-b border-(--border-color) hidden lg:p-0 p-[0_10px_0_10px] shrink-0">
          <div className="h-[8vh] w-[10%] flex items-center justify-center">
            <div
              className="h-7 w-7 lg:h-9 lg:w-9 border rounded-[50%] grid place-content-center lg:text-xl bg-[#84c346] text-white cursor-pointer"
            >
              <span>{initial}</span>
            </div>
          </div>
            ...
            <div className="h-[7vh] w-full flex">
              ...
              <div className="h-full w-[20%] flex justify-center items-center">
                <div className="h-9 w-16 bg-white hover:bg-neutral-200 border rounded-3xl text-black font-semibold cursor-pointer">
                  ...
                  >
                    {loading ? (
                      <div className="h-7 w-7 flex justify-center items-end animate-[bounce_0.5s_infinite]">
