...
const PostBox = () => {
  ...
  return (
    <>
      <div className="w-full sm:flex border-b border-(--border-color) hidden lg:p-0 p-[0_10px_0_10px] shrink-0">
        ...
        <div className="w-[90%] flex flex-col">
          ...
          {/* {list.map((p, i) => {
            <div key={i} className="h-25 w-100">
              {p.imageId && (
          ...
          {WhatsHappeingClicked && (
            <div className="w-[90%] flex justify-start items-center border-b border-(--border-color)">
              <div className="h-fit w-fit p-1 flex justify-center items-center gap-2 rounded-2xl fill-(--fill-blue-color) hover:bg-(--bg-dark-blue-color) active:bg-(--bg-dark-blue-color) cursor-pointer">
                ...
                <div className="text-[0.8rem] text-blue-400 text-center font-semibold">
          ...
          <div className="h-[7vh] w-full flex">
            <div className="h-full w-full flex items-center justify-start">
              <div
                ...
                className="h-7 w-7 p-1 border rounded-[50%] fill-(--fill-blue-color) hover:bg-(--bg-dark-blue-color) active:bg-(--bg-dark-blue-color) cursor-pointer"
              >
                <input
                  type="file"
                  ref={fileInputRef}
              ...
              <div className="h-7 w-7 p-1 border rounded-[50%] fill-(--fill-blue-color) hover:bg-(--bg-dark-blue-color) active:bg-(--bg-dark-blue-color) cursor-pointer">
                <svg viewBox="0 0 24 24" aria-hidden="true" class="">
                  <g>
