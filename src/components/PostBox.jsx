  ...
  return (
    <>
      <div className="h-fit w-full sm:flex border-b border-(--border-color) hidden lg:p-0 p-[0_10px_0_10px] shrink-0">
        ...
        <div className="h-fit w-[90%] flex flex-col">
          <div
          ...
          >
            <div className="h-fit w-full p-2 bg-black overflow-hidden">
              <textarea
                ...
                className="h-fit w-full border-none resize-none outline-none text-lg text-(--current-color) placeholder-neutral-500 overflow-hidden"
                rows={1}
              />
            </div>
          </div>
